...
//  this software.
//============================================================================
#ifndef vtk_m_exec_CellShapeMetric_h
#define vtk_m_exec_CellShapeMetric_h
/*
                                  ...
                                  const vtkm::exec::FunctorBase& worklet)
{
  ...
  OutType condition = vtkm::exec::CellConditionMetric<OutType, PointCoordVecType>(numPts, pts, vtkm::CellShapeTagTriangle, worklet);
                                 ...
                                 const vtkm::exec::FunctorBase& worklet)
{
  ...
  {
    case 3:
            return ComputeMeasure<OutType>(numPts, pts, vtkm::CellShapeTageTriangle(), worklet);
    case 4:
            return ComputeMeasure<OutType>(numPts, pts, vtkm::CellShapeTageQuad(), worklet);
    default:
            break;
  }
  return OutType(0.0);
...
#endif // vtk_m_exec_CellShapeMetric_h
