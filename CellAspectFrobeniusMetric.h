...
//  this software.
//============================================================================
#ifndef vtk_m_exec_cellmetrics_CellAspectFrobeniusMetric_h
#define vtk_m_exec_cellmetrics_CellAspectFrobeniusMetric_h
                              ...
                              const vtkm::exec::FunctorBase& worklet)
{
  ...
  UNUSED(pts);  
  UNUSED(shape);  
  worklet.RaiseError("Shape type template must be specialized to compute the aspect frobenius metric.");
  return OutType(0.0);
}
                                  ...
                                  const vtkm::exec::FunctorBase& worklet)
{
  ...
  FloatType sum = (FloatType)vtkm::MagnitudeSquared(TriEdges[0]) +
	  	  (FloatType)vtkm::MagnitudeSquared(TriEdges[1]) +
		  (FloatType)vtkm::MagnitudeSquared(TriEdges[2]);
                              ...
                              const vtkm::exec::FunctorBase& worklet)
{
  ...
  using Edge = typename PointCoordVecType::ComponentType;
  const Edge TetEdges[3] = {pts[1] - pts[0], //Base edge 1
...
#endif // vtk_m_exec_cellmetrics_CellAspectFrobeniusMetric_h
